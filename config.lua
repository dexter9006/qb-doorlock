...
Config.PersistentSaveInternal = 60 * 1000 -- How often door states are saved to the file system, in miliseconds. 
...
Config.DoorList = {
	...
	{
		objName = 'v_ilev_gb_vaubar',
		objCoords  = vec3(-2956.43, 484.54, 15.68),
		textCoords = vec3(-2956.43, 484.54, 15.68),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = true,
		distance = 1.5
